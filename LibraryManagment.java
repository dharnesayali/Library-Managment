...
class Librarian 
{
    ...
    public int addBook(String[] bookNames, String[] authorNames) 
    {
        ...
        if (numBook < 500) 
        {
            this.bookNames[numBook] = bookName;
            this.authorNames[numBook] = authorName;
            numBook++;
            return numBook - 1;
        } 
        else 
        ...
        while (true) {
            ...
            switch (ch) {
                ...
                case 5:
                    ...
                    String bookToRenew = scan.nextLine();
                    librarian.renewBook(bookToRenew);
                    break;
        ...
        do {
            ...
            switch (op) {
                ...
                case 2:
                    ...
                    System.out.println("Enter your name: ");
                    String studentNameReturn = scan.nextLine();
        ...
        do {
            ...
            switch (op) {
                case 1:
                    ...
                    librarian.borrowBook(bookToBorrow, facultyName);
                    break;
                ...
                case 2:
                    ...
                    String bookToReturn = scan.nextLine();
                    System.out.println("Enter your name: ");
                    String facultyNameReturn = scan.nextLine();
                    // Assuming returning a book doesn't need additional logic, just acknowledging it.
                    System.out.println("Book '" + bookToReturn + "' returned by " + facultyNameReturn);
                    break;
